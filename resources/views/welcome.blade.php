                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div
                        ...
                        <div>
                            <div
                                ...
                                <img viewBox="0 0 24 24" class="w-7 h-7 stroke-red-500"
                                    src="https://campusvirtual.peruanoespanol.edu.pe/uploads/leon.png" alt=""
                                    srcset="">

                            </div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Vision</h2>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Mision</h2>
